...
#ifdef VM
VirtualMemoryManager* virtMemManager;
Lock* virtMemManagerLock;
#endif // VM
...
#ifdef VM
virtMemManager = new VirtualMemoryManager();
virtMemManagerLock = new Lock("virtMemManagerLock");
#endif // VM
